...
def exibir_extrato(clientes):
    ...
    # -- Implementaração para exibir as transações Saques e Depósitos
    ...
    # Criar um menu no extrato para selecionar a opção de saque, depósito ou todos
    # -- Fim da Implementaração
